// mazebot_andysmethod: an Arduino project that operates a maze robot for AE 1
...
const short left0 = 92, right0 = 95; // Values at which the two servos converge to a stop
const long l90delay = 490, r90delay = 440, blockDelay = 1000, restDelay = 1000; // Delay time in milliseconds for turning left 90 deg, right 90 deg, going forward a block and rest
